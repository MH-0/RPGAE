...
parser.add_argument('--hidden-units', type=str, default="128,128",
...
parser.add_argument('--check-point', type=int, default=12.5, help="Eheck point")
...
parser.add_argument('--file-dir', type=str, required=False, default='..\\..\\..\\deepinfodata\\twitter',  help="Input file directory")
